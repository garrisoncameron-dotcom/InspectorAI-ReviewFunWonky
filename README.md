# InspectAid Agency OS

Separate GitHub Pages package for the InspectAid Agency OS enterprise build.

Suggested public URL:

`https://garrisoncameron-dotcom.github.io/InspectorAI-ReviewFunWonky/`

The root app is the agency operating shell. The existing production InspectAid inspection engine is preserved at:
